...
const UserProfile = () => {
  ...
  const loFiSongs = [
    ...
    { title: "Nighttime Serenity", url: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3" },
  ];
  ...
  return (
    <>
      <Header />
      <Sidebar />
      <div className="flex mt-18 items-center relative">
        <div className="ml-[110px] mt-12 w-[72%] p-5 bg-white rounded-2xl text-inherit font-poppins overflow-y-auto h-[calc(100vh-80px)] scrollbar-hide">
          {/* Profile Header */}
          <div className="flex items-center mb-6">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-gray-700 tracking-wider">@{username}</p>
              <button className="mt-2 rounded-xl mr-10 bg-[#611DD0] text-white px-4 py-2 font-medium">
                Edit Profile
              </button>
            </div>
          </div>
          ...
          {/* Story Highlights */}
          <div className="mb-6">
            <h3 className="text-2xl font-semibold mb-2 text-[#6B46C1] highlight-haven-title">
              Highlight Haven
            </h3>
            ...
            <div className="flex gap-4 overflow-x-auto scrollbar-hide">
              <div className="stories relative w-[180px] h-[150px] overflow-hidden rounded-[20px] before:absolute before:inset-0 before:bg-white/10">
                ...
                />
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-4xl font-cursive italic">
                  Travel
                </div>
              </div>
              <div className="stories relative w-[180px] h-[150px] overflow-hidden rounded-[20px] before:absolute before:inset-0 before:bg-white/10">
              ...
              >
                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-[#611DD0] text-4xl font-cursive italic">
                  Add
                </div>
              </div>
            </div>
          ...
          <div className="flex gap-6 mb-6">
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-[#611DD0]">
            ...
            <div className="flex-1">
              <h3 className="text-xl text-[#1438A6] font-semibold">About Me</h3>
        ...
        <div className="mood-maker w-[10%] mr-10 absolute right-10 top-12">
          ...
          <div className="chill-corner ml-2 p-4 w-[320px] bg-white mt-5 rounded-2xl shadow">
